...
export default function TableRows({ columns, list, dataArray, arrayHandler }) {
    ...
    const callHandler = (element) => {
        ...
        const callType = target.getAttribute('title') === 'Llamada Anónima' ? 'Anonymous' : 'Simulated';
                ...
                for (const beneficiary of dataArray) {
                    tableRows.push(
                        <tr key={beneficiary.id}>
                            <td>{beneficiary.name.charAt(0).toUpperCase() + beneficiary.name.slice(1)}</td>
                            <td>
                                <Link className="btn btn-primary callButton" title='Llamada Entrante' about={beneficiary.id} to='/callform' onClick={callHandler}>
                            ...
                            <td>
                                <Link className="btn btn-outline-dark" title='Llamada Anónima' about={beneficiary.id} to='/callform' onClick={callHandler}>
                ...
                for (const beneficiary of dataArray) {
                    tableRows.push(
                        <tr key={beneficiary.id}>
                            <td>{beneficiary.name.charAt(0).toUpperCase() + beneficiary.name.slice(1)}</td>
                            <td>
                                <Link className="btn btn-primary callButton" title='Llamada Saliente' about={beneficiary.id} to='/callform' onClick={callHandler}>
