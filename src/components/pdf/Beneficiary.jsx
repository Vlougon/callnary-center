                    ...
                    <View key={beneficiary.id} style={styles.dataRow}>
                        <View key={beneficiary.id} style={styles.dataRow}>
                            <View style={styles.dataPair}>
                                ...
                                <Text style={styles.dataLabel}>Número de Seguridad Social: {beneficiary.NSS}</Text>
                                <Text style={styles.dataLabel}>Tipo de Beneficiario: {beneficiary['Tipo de Beneficiario']}</Text>
                            </View>
                            <View style={styles.dataPair}>
                                ...
                                <Text style={styles.dataLabel}>Teléfono: {beneficiary['Phone ']}</Text>
